...
namespace ClubAdministration.Controllers.coaches
{
    public partial class coachesController : BaseController
    {
        ...
        public ActionResult CreatePlan([Bind(Include = "ID,coach_name,coach_family,coach_birthday,coach_gender,registeration_date")] coach coach)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditPlan([Bind(Include = "ID,coach_name,coach_family,coach_birthday,coach_gender,registeration_date")] coach coach)
        {
            if (ModelState.IsValid)
            {
